...
print(
    xtable(ans,
        caption = "TCGA ACC Methylation450 (80 rows x 394,014 columns, threshold=0.99)", label = "TCGA3", caption.placement = "top")
  ,size="small", table.placement="ht", include.rownames=FALSE)
@
...
\bibitem{sup}
Lewis, Bryan,  \url{https://github.com/bwlewis/tcor}.
