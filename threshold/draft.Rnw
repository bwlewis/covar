...
example\cite{prune1, prune2, prune3, prune4}
...
%% Related use of SVD in neural networks
\bibitem{neural}
...
\bibitem{prune4}
Zhu, Shiwei, et al. Scaling up top-K cosine similarity search. Data \& Knowledge Engineering 70.1 (2011): 60-83.
