...
The `cov` and `cor` functions in the R programming language include several approaches for dealing with missing data. The `use="pairwise.complete.obs"` option is particularly confusing, and can easily lead to faulty comparisons. This note explains and warns against its use.
