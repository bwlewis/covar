...
and `cov` functions. The note illustrates potential issues using
a very simple pathological example and lists alternative approaches
to handling missing data and references about them.
